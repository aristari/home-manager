...
in
{
  ...
  options.programs.claude-code = {
    ...
    plugins = lib.mkOption {
      ...
      default = [ ];
      description = ''
        Plugin directories or packages to load into Claude Code via
        `--plugin-dir`. Each entry should be a path to a directory
        containing a valid Claude Code plugin.
      '';
    ...
    marketplaces = lib.mkOption {
      ...
      default = { };
      description = ''
        List of sources for marketplaces.
      '';
    };
